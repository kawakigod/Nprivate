...
from Natsuki import HEROKU_API_KEY, HEROKU_APP_NAME, OWNER_ID
from Natsuki import UPSTREAM_REPO as UPSTREAM_REPO_URL
from Natsuki import telethn as update
from Natsuki.events import register

if not UPSTREAM_REPO_URL:
    UPSTREAM_REPO_URL = "https://github.com/Sadew451/Natsuki-v2.4"
