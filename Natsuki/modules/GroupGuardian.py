...
# from Natsuki.db.mongo_helpers.nsfw_guard import add_chat, get_all_nsfw_chats, is_chat_in_db, rm_chat
...
from Natsuki.services.sql.nsfw_watch_sql import (
    add_nsfwatch,
...
__help__ = """
<b> Group Guardian: </b>
✪ Natsuki can protect your group from NSFW senders, Slag word users and also can force members to use English
