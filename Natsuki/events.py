...
from Natsuki import CMD_LIST, LOAD_PLUG, tbot
import glob
import sys
from Natsuki import ubot
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"Natsuki/modules/{shortname}.py")
        name = "Natsuki.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["Natsuki.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "Natsuki/modules/*.py"
