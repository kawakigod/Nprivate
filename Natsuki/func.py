from Natsuki import tbot as borg
from Natsuki import TEMP_DOWNLOAD_DIRECTORY as TMP_DOWNLOAD_DIRECTORY
...
import asyncio
import os
from Natsuki.Ok import upload_file, download_file
